...
p;13;TNStackView.jt;3200;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;3133;
objj_executeFile("Foundation/Foundation.j",NO);
objj_executeFile("AppKit/AppKit.j",NO);
...
_18.origin.y=_18.origin.y+_18.size.height+_padding;
_18.origin.x=_padding;
}else{
_18=CGRectMake(_padding,_padding,objj_msgSend(_15,"bounds").size.width-(_padding*2),0);
}
return _18;
}
